...
interface IAlertManualClose {
  customClass?: string;
}

function AlertManualClose({ customClass }: IAlertManualClose) {
  ...
  return (
    <SectionContainer
      customClass={`alertManualClose ${customClass}`}
      title="Button filled"
    ...
    >
      <SectionContainerRow title="normal" direction="column" space={40}>
        <Button
          projectType="primary"
          dispatchEvent={() => setOpenPrimary(true)}
        >
          Open primary
        </Button>
        <Alerts
        ...
        <Button
          projectType="success"
          dispatchEvent={() => setOpenSuccess(true)}
        >
          Open Success
        </Button>
        <Alerts
        ...
        <Button
          projectType="warning"
          dispatchEvent={() => setOpenWarning(true)}
        >
          Open Warning
        </Button>
        <Alerts
